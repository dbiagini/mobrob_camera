...
/*void matrix_rotation(float angle, int axe, float * rot){

switch(axe){
  default:   //x small angles
    rot[0]=1;   rot[1]=0;           rot[2]=0;           
    rot[3]=0;   rot[4]=1;           rot[5]=-angle;  
    rot[6]=0;   rot[7]=angle;       rot[8]=1; 
   
    break;
  case 1:  //y
    rot[0][0]=cos(angle); rot[0][1]=0;    rot[0][2]=-sin(angle);rot[0][3]=0;
    rot[1][0]=0;          rot[1][1]=1;    rot[1][2]=0;          rot[1][3]=0;
    rot[2][0]=sin(angle); rot[0][1]=0     rot[2][2]=cos(angle); rot[2][3]=0;
    rot[3][0]=0;          rot[0][1]=0;    rot[3][2]=0;          rot[3][3]=1;
    break;
  case 2:  //z
    rot[0][0]=cos(angle);   rot[0][1]=sin(angle);  rot[0][2]=0; rot[0][3]=0;
    rot[1][0]=-sin(angle);  rot[1][1]=cos(angle);  rot[1][2]=0; rot[1][3]=0;
    rot[2][0]=0;            rot[0][1]=0            rot[2][2]=1; rot[2][3]=0;
    rot[3][0]=0;            rot[0][1]=0;           rot[3][2]=0; rot[3][3]=1;
    break;
  }
  rot[0]=1;   rot[1]=0;           rot[2]=0;           
